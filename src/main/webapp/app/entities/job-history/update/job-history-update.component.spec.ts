...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 18719 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 28776 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 19812 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 27963 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 555 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 6199 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 3279 };
      jobHistory.job = job;
      const department: IDepartment = { id: 21591 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 28030 };
      jobHistory.employee = employee;
