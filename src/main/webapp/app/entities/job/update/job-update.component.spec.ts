...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 10025 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 9279 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 29712 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 27002 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 29937 };
      job.tasks = [task];
      const employee: IEmployee = { id: 5209 };
      job.employee = employee;
